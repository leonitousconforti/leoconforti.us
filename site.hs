...
import           Skylighting                     (Style (..), ToColor (..),
                                                  TokenStyle (..),
                                                  TokenType (..), defStyle)
...
main = hakyll $ do
    ...
    match "css/*.hs" $ do
        ...
        compile $ getResourceString >>= withItemBody (unixFilter "cabal" ["exec", "--", "runghc", "-v0"])
    ...
    create ["posts.html"] $ do
        ...
        compile $ do
            ...
            let postsCtx =
                    ...
                    constField "title" "Leo's Post Library" <>
    ...
    match "data/albums.yaml" $ do
      ...
      compile $ do
        ...
        let albumsCtx =
                ...
                constField "title" "Leo's Top Albums Library" <>

...
it might just be a random 32bit signed integer as a salt. And looking at the
last sequence of the request, it looks like a md5 or sha hash to me.
...
Specifically, I want to learn how the salt for the requests are generated and
how the hashes for the requests are computed

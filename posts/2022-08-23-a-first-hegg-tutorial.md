...
title: Equality Saturation in Haskell, a tutorial

description: A first tutorial for equality saturation with hegg, a library of
             e-graphs and fast equality saturation written in Haskell. This tutorial
             implements a symbolic manipulation library using hegg.

tags: egraphs, algorithms, haskell

---

`hegg` is a Haskell-native library providing fast e-graphs and equality
saturation, based on [*egg: Fast and Extensible Equality
Saturation*](https://arxiv.org/pdf/2004.03082.pdf) and [*Relational
E-matching*](https://arxiv.org/pdf/2108.02290.pdf).

Suggested material on equality saturation and e-graphs for beginners

* [egg: Fast and Extensible Equality Saturation in a 5m video](https://www.youtube.com/watch?v=ap29SzDAzP0)
* [egg's users guide](https://docs.rs/egg/latest/egg/tutorials/_01_background/index.html)
...
saturation, from a `hegg` user's perspective. Until then, this rough tutorial
serves as an alternative.

# Symbolic Maths in E-graphs

If you've never heard of symbolic mathematics you might get some intuition from
reading [Let’s Program a Calculus Student](https://iagoleal.com/posts/calculus-symbolic/) first.
...
# Equality saturation on symbolic expressions
